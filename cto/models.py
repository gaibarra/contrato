...
class Contratos(ClaseModelo2):
    ...
    rfc_sociedad = models.CharField(max_length=12, blank=True, null=True, default="" )
    tipo_sociedad = models.CharField(max_length=150, blank=True, null=True , default="" )
    testimonio = models.CharField(max_length=150, blank=True, null=True , default="" )
    clausula = models.CharField(max_length=150, blank=True, null=True , default="" )
