...
def coverletter_export(request, id):
    ...
    if tipoc.id == 7:
        nums = (314, 315, 316, 317, 318, 319, 320, 321, 322, 323, 324, 325, 326, 327, 826, 827, 828, 829, 830, 831, 832, 834, 835, 836, 837, 328, 338, 339, 340, 341, 342, 343, 344, 345, 346,
    ...
    if tipoc.id == 8:
        nums = (384, 385, 386, 387, 388, 389, 390, 391, 392, 393, 394, 395, 396, 397, 398, 399, 400, 401, 402, 403, 404, 405, 406, 407, 824, 825, 409, 410, 411, 412, 417, 418, 419, 421,
                422, 423, 424, 425, 426, 427, 428,   429, 430, 431, 432, 433,  434, 435, 436, 437, 438, 439, 440, 441, 442, 443, 444, 445, 446, 447, 448, 449, 450,  453, 454, 455, 456, 457)

    if tipoc.id == 9:
        nums = (460, 461, 462, 463, 464, 465, 466, 467, 468, 469, 470, 471, 472, 473, 474, 475, 476, 477, 478, 479, 480, 481, 482, 483, 484, 822, 823, 485, 486, 487, 488, 489, 490, 491, 492, 493, 494, 495,
    ...
    if tipoc.id == 10:
        nums = (535, 536, 537, 538, 539, 540, 541, 542, 543, 544, 545, 546, 547, 548, 549, 550, 551, 552, 553, 554, 555, 556, 557,  558, 820, 821, 559, 560, 818, 819, 561, 562, 563, 564, 565, 566,
    ...
    if tipoc.id == 6:
        nums = (249, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 841, 840, 264, 265, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276, 277, 278, 279,
