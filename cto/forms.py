...
class PartesForm(ModelForm):
    ...
    class Meta:
        ...
        fields = ['claveDepartamento', 'estatusParte', 'codigo', 'tituloParte', 'nombresParte', 'apellidoPaternoParte', 'apellidoMaternoParte', 'fecha_ingreso', 'email', 'lugarnacimientoParte', 'rfc', 'imss',  'curp',
                  'nacionalidadParte', 'estadocivilParte', 'regfiscalParte', 'cedula_profParte', 'titulo_profParte', 'universidadParte', 'domicilioParte', 'phone', 'mobile', 'grupo_sanguineo', 'alergias', 'clavePuesto', 'actividadesParte']
        exclude = ['um', 'fm', 'uc', 'fc']
...
class ContratosForm(forms.ModelForm):
    ...
    class Meta:
        model = Contratos
        fields = ['id', 'tipocontrato',  'parte2', 'datecontrato_ini', 'datecontrato_fin', 'importeContrato', 'status', 'npContrato', 'imppContrato', 'totalhorasContrato',
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.fields['datecontrato'].widget.attrs['style'] = "width:200px"
